...
async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "rubinowe@rubinowe.pl", // Your email where you'll receive emails
      from: "rubinowe@rubinowe.pl", // your website email address here
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
              ...
              <hr />
              <p class="footer" style="font-size: 16px;padding-bottom: 20px;border-bottom: 1px solid #D1D5DB;">Regards<br>Rubinowe.pl Team</p>
  ...
  return res.status(200).json({ success: "message send" });
}
